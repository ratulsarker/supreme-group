...
export const metadata: Metadata = {
  ...
  description: "Leading garment accessories manufacturer in Bangladesh producing poly bags, labels, threads, elastic, twill tape, and more.",
};
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }}>
            <div>
              <h2 style={{ fontFamily: "var(--font-head)", fontSize: "2.2rem", fontWeight: 700, color: "#0B1D2E", marginBottom: "16px" }}>
                A Reliable <span style={{ color: "#0E86D4" }}>One-Stop Solution</span>
              </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "0" }}>
            {[
              ...
              <div key={s.label} style={{
                ...
                <div style={{ fontFamily: "var(--font-head)", fontSize: "2rem", fontWeight: 700, color: "#0B1D2E", lineHeight: 1 }}>
                  {s.num}
                </div>
